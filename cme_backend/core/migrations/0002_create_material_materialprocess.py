    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('material_type', models.CharField(db_column='tx_material_type', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('material', models.ForeignKey(db_column='id_material', db_index=False, on_delete=django.db.models.deletion.DO_NOTHING, related_name='processes', to='core.material', verbose_name='Material')),
            ],
            options={
